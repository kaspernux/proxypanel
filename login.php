...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$result) {
        die('Произошла ошибка: ' . mysqli_error($conn));
    } else {
    }
            ...
            <div class="flex items-center justify-center p-6">
                <div class="" style="width: 65%">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <img src="icons/grambot.png" class="mx-auto">
                        <br>
                        <br>
                        ...
                        <p style="font-size: 14px">wizwiz 9.1.9 Beta<span style="color:red;">
...
<!--
* Proxygram v9.1.9 Beta
* https://github.com/kaspernux/proxygram-bot
* Copyright (c) @ProxygramHub
-->