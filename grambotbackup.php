...
<div class="px-6 my-2 mt-4">
    <a href="https://t.me/ProxygramHub" target="_blank">
        <button
...
<div class="px-6 my-2">
    <a href="https://github.com/kaspernux/proxygram-bot" target="_blank">
        <button
...
>
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <div class="ml-2 flex justify-start items-center ">
            <img width="40px" src="./icons/grambot.png">
            <a class=" text-lg font-bold text-gray-800 dark:text-gray-200" href="index.php" > WizWiz <span class="px-1 ml-1 rounded" style="font-size: 10px;background-color: #e7cef1;color:#45013c !important;"> v 9.1.9 Beta</span></a>
        </div>
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                <a
        ...
        <div class="flex flex-col justify-between h-full">
            ...
            <p class="px-6 py-2 text-xs text-gray-600 dark:text-gray-400">
               ip: ' . $row_servers['ip'] . '
                    ...
                    <a href="grambotbackup.php?delete=' . $row_servers['id'] . '">
                    ...
                    if ($row_servers['status'] == '1') {
                        echo '<a href="grambotbackup.php?off=' . $row_servers['id'] . '">
                    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" class="m-1" width="20" fill="#219ebc"><path d="M23.821,11.181v0C22.943,9.261,19.5,3,12,3S1.057,9.261.179,11.181a1.969,1.969,0,0,0,0,1.64C1.057,14.739,4.5,21,12,21s10.943-6.261,11.821-8.181A1.968,1.968,0,0,0,23.821,11.181ZM12,18a6,6,0,1,1,6-6A6.006,6.006,0,0,1,12,18Z"/><circle cx="12" cy="12" r="4"/></svg>
                        ...
                        echo '<a href="grambotbackup.php?on=' . $row_servers['id'] . '">
        ...
        if (isset($_GET['delete'])) {
			...
			if(is_numeric($id_delete_server)){
				...
				if (!$stmt) {
					$error = $stmt->error;
					$stmt->close();
		die("Ошибка базы данных: " . $error);
				} else {
					$stmt->close();
					deletewizwiz();
					header("location: grambotbackup.php");
				}
			}
        }
