...
>
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <div class="ml-2 flex justify-start items-center ">
            ...
            <a class=" text-lg font-bold text-gray-800 dark:text-gray-200" href="index.php" > Proxygram <span class="px-1 ml-1 rounded" style="font-size: 10px;background-color: #e7cef1;color:#45013c !important;"> v 9.1.9 Beta</span></a>
        </div>
                    ...
                    <table class="w-full whitespace-no-wra">
                        ...
                        if (is_array($users_select) || is_object($users_select)) {
                            foreach ($users_select
                                ...
                                echo '<img class="object-cover w-full h-full rounded-full" src="icons/grambot.jpg" alt="" loading="lazy">';
